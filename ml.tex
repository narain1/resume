...
\begin{flushleft}
    ...
    \begin{itemize}
        ...
        \item Implemented \textbf{Vector Databases} and \textbf{data engineering pipelines} on \textbf{OpenSearch} for scalable Information retrieval.
...
\begin{flushleft}
    ...
    \item \textbf{\large Compiler System for Deep Learning Graph Optimization and Op-Fusion}
        ...
        \begin{itemize}
            ...
            \item Implemented a kernel mapping strategy leveraging TVM and TASO, enhancing performance.
            \item Designed high performant SIMD kernels for Edge Devices (ARM NEON) for Computer Vision algorithms.
            \item Developed custom CUDA kernels for deployment on Jetson Orin, achieving speedups benchmarked against OpenCV C++.
        \end{itemize}
