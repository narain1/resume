...
\begin{flushleft}
    ...
    \vspace{1.5mm}
    \hspace{1.5mm} \textbf{\large AI Engineer, \href{https://ai.asu.edu/ai-tools/ai-acceleration-team}{ASU Enterprise Technology}},   Tempe, USA \hfill \textit{\large Jan '24 $-$ Present}	\\
    \begin{itemize}
        ...
        \item \textbf{Built ML infrastructure} on ASU’s SOL Cluster using Kubernetes, enabling dynamic resource scaling for inference.
